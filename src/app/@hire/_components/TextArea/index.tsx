    ...
    return (
        <div className="w-full max-w-xl md:max-w-none flex flex-col md:flex-row gap-x-4">
            ...
            <div className="flex-1 flex flex-col">
                <textarea id={ label } value={ value } onChange={ (e) => setValue(e.target.value) } { ...props } className={ `${error ? 'border-red-600' : 'border-[var(--border)]'} w-full px-4 py-2 bg-white border rounded-md transition focus-visible:outline-[var(--primary)] disabled:bg-[var(--accent)] disabled:cursor-not-allowed` }></textarea>
